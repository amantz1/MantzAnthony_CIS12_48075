...
<div id="nav2">
    <ul>
        ...
        <li><a href="./Hmwk/Ullman Scripts/index.php" target="frame">Ullman Scripts</a></li>
    </ul>
</div>
    <p id="framenote"><em>Please choose a link above to see what the code does or <a href="https://github.com/amantz1/MantzAnthony_CIS12_48075/tree/master/Hmwk" target="_blank">click here</a> to see the code on github.</em></p>
