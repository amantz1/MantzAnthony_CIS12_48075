...
if (isset($_GET['p']) && is_numeric($_GET['p'])) { // Already been determined.
	...
	$q = "SELECT COUNT(user_id) FROM am1346043_ullman_users";
...
// Define the query:
$q = "SELECT last_name, first_name, DATE_FORMAT(registration_date, '%M %d, %Y') AS dr, user_id FROM am1346043_ullman_users ORDER BY $order_by LIMIT $start, $display";		
