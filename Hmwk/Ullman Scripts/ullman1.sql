...
CREATE TABLE am1346043_ullman_users (
...
INSERT INTO am1346043_ullman_users 
(first_name, last_name, email, pass, registration_date) 
VALUES ('Larry', 'Ullman', 'email@example.com', SHA1('mypass'), NOW());

INSERT INTO am1346043_ullman_users VALUES 
(NULL, 'Zoe', 'Isabella', 'email2@example.com', SHA1('mojito'), NOW());

INSERT INTO am1346043_ullman_users (first_name, last_name, email, pass, registration_date) VALUES
...
UPDATE am1346043_ullman_users SET email='mike@authors.com' WHERE user_id = 18;

DELETE FROM am1346043_ullman_users WHERE user_id = 8 LIMIT 1;
